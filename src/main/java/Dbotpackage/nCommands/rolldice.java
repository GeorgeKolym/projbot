...
public class rolldice extends ListenerAdapter {
    ...
    public void onMessageReceived(@NotNull MessageReceivedEvent event) {
        ...
        String[] m = event.getMessage().getContentRaw().split(" ");
        MessageChannel gc = event.getMessage().getChannel();
        ...
        if (m[0].equalsIgnoreCase("r!help")) {
            ...
            if (m.length == 1) {
                ...
                System.out.println("d6 rolled by " +  event.getMember().getUser() + "rolled " + d6s);
            } else if (! event.getMember().getUser().isBot()) {
                v = Integer.parseInt(m[1]);
                System.out.println("d6 rolled " + v + " times by " +  event.getMember().getUser());
                for (int i = 0; i < v; i++) {
            ...
            if (m.length == 1) {
                ...
                System.out.println("d8 rolled by " +  event.getMember().getUser() + "rolled " + d8s);
            } else if (! event.getMember().getUser().isBot()) {
                v = Integer.parseInt(m[1]);
                System.out.println("d8 rolled " + v + " times by " +  event.getMember().getUser());
                for (int i = 0; i < v; i++) {
            ...
            if (m.length == 1) {
                ...
                System.out.println("d10 rolled by " +  event.getMember().getUser() + "rolled " + d10s);
            } else if (! event.getMember().getUser().isBot()) {
                v = Integer.parseInt(m[1]);
                System.out.println("d10 rolled " + v + " times by " +  event.getMember().getUser());
                for (int i = 0; i < v; i++) {
            ...
            if (m.length == 1) {
                ...
                System.out.println("d100 rolled by " +  event.getMember().getUser() + "rolled " + d100s);
            } else if (! event.getMember().getUser().isBot()) {
                v = Integer.parseInt(m[1]);
                System.out.println("d100 rolled " + v + " times by " +  event.getMember().getUser());
                for (int i = 0; i < v; i++) {
            ...
            if (m.length == 1) {
                ...
                System.out.println("d12 rolled by " +  event.getMember().getUser() + "rolled " + d12s);
            } else if (! event.getMember().getUser().isBot()) {
                v = Integer.parseInt(m[1]);
                System.out.println("d12 rolled " + v + " times by " +  event.getMember().getUser());
                for (int i = 0; i < v; i++) {
            ...
            if (m.length == 1) {
                ...
                System.out.println("d20 rolled by " +  event.getMember().getUser() + "rolled " + d20s);
            } else if (! event.getMember().getUser().isBot()) {
                v = Integer.parseInt(m[1]);
                System.out.println("d20 rolled " + v + " times by " +  event.getMember().getUser());
                for (int i = 0; i < v; i++) {
